 ...
 */
void skrivMeny()  {
   cout << "\nF0lgende kommandoer er tilgjengelige:\n"
        << "\n   A  - skriv Alle gjenstandene"
        << "\n   M  - skriv alt om gjenstand(er) Med et gitt navn"
        << "\n   T  - skriv gjenstander av en viss Type (maleri, mobel, ting)"
        << "\n   N  - Ny gjenstand"
...
void slettGjenstand() {
    ...
    if (antall > 0) {                        //  Gjenstand(er) ble funnet:
        cout << "\n\tOnsker du VIRKELIG aa slette/fjerne "
