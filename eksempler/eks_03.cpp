...
int main() {
  ...
  *iPeker = 41;                           //  VERDIEN til 'ipeker' blir 41.
  ...
  if (cPeker)
    cout << "'cPeker' peker til noe reelt."; //  != nullptr ?
  else
    cout << "'cPeker' peker til 'nullptr'."; //  == nullptr !
  cout << "\n\n";
  ...
  cout << "\nTeksten er:   " << cPeker;
  cout << "\nPersonen er:  " << persPeker->navn << ", " << persPeker->alder
       << "\n\n";
  ...
  int lengde = lesInt("Onsket tekstlengde", 20, 80);
