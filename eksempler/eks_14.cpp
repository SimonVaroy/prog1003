...
class Person  {
  ...
  public:
      Person()          {  cout << "'Person' MAA opprettes med et navn!\n";  }
...
class Ansatt : public Person  {
  ...
  public:
      Ansatt()  {  cout << "'Ansatt' MAA opprettes med et navn!\n";  }
...
class Student : public Person {
  ...
  public:
    Student()   {  cout << "'Student' MAA opprettes med et navn!\n";  }
...
//                        evt. senere:     Person::lesData();
    ...
    ansattAar  = lesInt("\tAnsattaar", 1980, 2020);
    lonnstrinn = lesInt("\tLonnstrinn", 19, 101);
...
//                        evt. senere:     Person::skrivData();
    cout << tittel << ' ' << navn << ((lederstilling) ? ", Leder" : "")
         << "\n\t\tRom: " << romNr << ", ansatt i " << ansattAar
         << " og har naa ltr." << lonnstrinn << '\n';
}
...
//                        evt. senere:     Person::lesData();
  int grad = lesInt("\tNaavaerende grad (1=Bachelor, 2=Master, 3=PhD)", 1, 3);
  ...
  startAar = lesInt("\tStudiets startaar", 2015, 2020);
}
...
//                        evt. senere:     Person::skrivData();
    cout << navn << " startet i " << startAar << " paa ";
