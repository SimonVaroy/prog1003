...
int main()  {
    ...
    cout << "Element med nokkel 9 fjernet fra 'mengde2'.\n";
    if (mengde2.erase(6))                 //    og  6:
        cout << "Element med nokkel 6 fjernet fra 'mengde2'.\n";

    mengde2.erase(mengde2.begin(), mengde2.find(4));  // '4' MÅ finnes !!!
    cout << "'mengde2' der ALLE nokler OPP TIL 4 er slettet/fjernet:\n";
                                                         skrivMengde(mengde2);
