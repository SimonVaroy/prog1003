...
// *******************************   VECTOR:   *******************************
    ...
    cout << "\n\n'tall' vha. vanlig for-lokke og indeksering:  ";
    for (int i = 0; i <= 10; i++)
        cout << ' ' << tall[i];
...
// ---------------------------------------------------------------------------
    ...
    cout << "\n\n'tall' vha. iterator, naar slettet ALT f.o.m 77:  ";
    for (auto tallIt2 = begin(tall);  tallIt2 != end(tall);  tallIt2++)
        cout << ' ' << *tallIt2;
