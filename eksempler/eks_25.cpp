...
int main()  {
    ...
    cout << "\n\nFunksjon kjores for hvert element:\n";
    for_each(tekster.begin(), tekster.end(), gjorNoe);          //  FOR_EACH:

    cout << "\n\nFunksjon kjores for hvert element - vha.lambda-funksjon:\n";
