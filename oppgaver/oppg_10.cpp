...
void fjernBok()  {
  if (!gBokene.empty())  {                         //  Bøker er registrert:
     ...
     gBokene.pop_back();                         //  Siste PEKER slettes også!
      ...
      cout << "\n\tUmulig aa fjerne, da ingen boker registrert!\n";
}
...
void lestBok() {
  if (!gBokene.empty())             //  Bøker er registrert:
     ...
     cout << "\n\tUmulig aa sette bok som lest, da ingen boker registrert!\n";
}
...
void skrivBok() {
  if (!gBokene.empty())             //  Bøker er registrert:
     ...
     cout << "\n\tUmulig aa skrive EN gitt bok, da ingen boker registrert!\n";
}
