...
class Bil : public Kjoretoy  {
  ...
  public:
      virtual void lesData()  {
          Kjoretoy::lesData();
          antPassasjerer = lesInt("\tNaavaerende antall passasjerer", 0, 6);  }
...
class Vogntog : public Kjoretoy  {
  ...
  public:
      virtual void lesData() {
          Kjoretoy::lesData();
          tonnLast = lesFloat("\tNaavaerende tonn last", 0, 50);
      }
...
int main ()  {
    ...
    cout << "\n\nAntall kjoretoy: " << antallKjoretoy << "\n\n";


    for (i = 0; i < antallKjoretoy; i++) {     //  Skriver ALLE kjøretøyene:
        cout << "Kjoretoy nr. " << i+1 << ":  ";
        gKjoretoyene[i]->skrivData();
    }

                                               //  Skriver nr. til de tomme:
    cout << "\n\nKjoretoy som er tomme (for passasjerer eller last):\n\tNr:";
